...
from EMPLOYEES
where ROWNUM < 11;
-- ROWNUM keyword DOES NOT work with = sign, limit works in MYSQL-POSTGRES
...
select FIRST_NAME || ' makes ' || SALARY as "Employees Salary"
from EMPLOYEES;
select FIRST_NAME || ' makes ' || SALARY || ' ' || JOB_ID as "Employees Salary"
from EMPLOYEES;
...
drop view SDETS;
-- We delete the table with this command
